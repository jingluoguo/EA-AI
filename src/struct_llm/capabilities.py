...
class StructuralCapabilities:
    ...
    def with_statement_parsers(self, *parsers: StatementParser) -> StructuralCapabilities:
    ...
    def with_state_projectors(self, *projectors: StateProjector) -> StructuralCapabilities:
        return StructuralCapabilities(
    ...
    def with_state_reducers(self, *reducers: StateReducer) -> StructuralCapabilities:
        return StructuralCapabilities(
            statement_parsers=self.statement_parsers,
            state_projectors=self.state_projectors,
    ...
    def with_query_parsers(self, *parsers: QueryParser) -> StructuralCapabilities:
        return StructuralCapabilities(
            statement_parsers=self.statement_parsers,
            state_projectors=self.state_projectors,
            state_reducers=self.state_reducers,
    ...
    def with_rule_inferers(self, *inferers: RuleInferer) -> StructuralCapabilities:
        return StructuralCapabilities(
            statement_parsers=self.statement_parsers,
            state_projectors=self.state_projectors,
            state_reducers=self.state_reducers,
    ...
    def with_answerers(self, *answerers: Answerer) -> StructuralCapabilities:
        return StructuralCapabilities(
            statement_parsers=self.statement_parsers,
            state_projectors=self.state_projectors,
            state_reducers=self.state_reducers,
